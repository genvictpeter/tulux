...
tie %Config, 'Config', {
    ...
    cc => 'aarch64-oe-linux-gcc  -fstack-protector-strong -pie -fPIE -D_FORTIFY_SOURCE=2 -Wa,--noexecstack -Wformat -Wformat-security -Werror=format-security ',
    cccdlflags => '-fPIC',
    ...
    eunicefix => ':',
    exe_ext => '',
    full_ar => 'aarch64-oe-linux/aarch64-oe-linux-ar',
    inc_version_list => ' ',
    installman1dir => '',
    installman3dir => '',
    ...
    intsize => '4',
    ld => 'aarch64-oe-linux-gcc  -fstack-protector-strong -pie -fPIE -D_FORTIFY_SOURCE=2 -Wa,--noexecstack -Wformat -Wformat-security -Werror=format-security ',
    lddlflags => '-Wl,-O1 -Wl,--hash-style=gnu -Wl,--as-needed -Wl,-z,relro,-z,now,-z,noexecstack -fstack-protector -shared',
    ldflags => '-Wl,-O1 -Wl,--hash-style=gnu -Wl,--as-needed -Wl,-z,relro,-z,now,-z,noexecstack -fstack-protector',
